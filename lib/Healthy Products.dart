            ...
            children: [
              ...
              Center(
                child: ConstrainedBox(
                  constraints: const BoxConstraints.tightFor(width: 260, height: 200),
                  child: CustomPaint(
...
Row(
        ...
        child: TextFormField(
          decoration: InputDecoration(
            hintText: 'Enter original price',
                hintStyle: TextStyle(fontSize: 12), // Change 16 to the desired font size
  ...
  child: ElevatedButton(
    ...
    style: ElevatedButton.styleFrom(
      backgroundColor: Color(0xff35a072), // لون الخلفية
      padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10), // الهامش الداخلي
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10), // الشكل الخارجي
      ),
    ),
    child: Text(
      "Add Product",
